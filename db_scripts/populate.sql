...
insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Tapada das Necessidades", "Parque ", 38.708919, -9.169747 );
insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Jardim da Estrela ", "Jardim ", 38.714742, -9.159373);
insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Jardim Botânico ", "Jardim ", 38.718283, -9.148578);

insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Village Underground Lisboa", "Centro Cultural ", 38.700496, -9.178309);
insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Lx Factory ", "Centro Artistico ", 38.703464, -9.178862);
insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Biblioteca de Alcântara ", "Biblioteca ", 38.706386, -9.177748);
insert table local(loc_name, loc_desc, loc_x, loc_y) values ("AINORI Galeria de Arte ", "Galeria de Arte ", 38.705883, -9.175589);

insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Biblioteca Palácio Galveias ", "Biblioteca ", 38.741591, -9.143937);
insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Museu Caloste Gulbenkian ", "Museu ", 38.737712, -9.153481);
insert table local(loc_name, loc_desc, loc_x, loc_y) values ("Jardim amnistia ", "Jardim ", 38.736707, -9.164851);
